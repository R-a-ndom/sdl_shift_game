...
static void debug_draw_cross(SDL_Renderer* rend)
{
  ...
  SDL_RenderDrawLine(rend, HALF_SCREEN_WIDTH, 0, HALF_SCREEN_WIDTH,  main_win_height);
  SDL_RenderDrawLine(rend, 0, HALF_SCREEN_HEIGHT, main_win_width, HALF_SCREEN_HEIGHT);
}
#endif
